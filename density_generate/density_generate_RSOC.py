...
test_data_images_pth = os.path.join(root, 'test_data_RSOC_2048', 'images')
test_data_map_pth = os.path.join(root, 'test_data_RSOC_2048', 'gt_density_map')
test_data_show_pth = os.path.join(root, 'test_data_RSOC_2048', 'gt_show')
train_data_images_pth = os.path.join(root, 'train_data_RSOC_2048', 'images')
train_data_map_pth = os.path.join(root, 'train_data_RSOC_2048', 'gt_density_map')
train_data_show_pth = os.path.join(root, 'train_data_RSOC_2048', 'gt_show')
...
for pth in img_paths:
    ...
    if str(pth).find('train') > 0:
        ...
        target_pth = img_pth.replace('train_RSOC', 'train_data_RSOC_2048')
    if str(pth).find('val') > 0:
        img_pth = pth.replace('labelTxt-v1.5/DOTA-v1.5_val_hbb','images').replace('.txt','.png')
        target_pth = img_pth.replace('val_RSOC', 'test_data_RSOC_2048')
